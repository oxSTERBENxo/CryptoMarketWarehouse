...
/** Loading skeleton shown only for the first generation (before any analysis exists) -- reuses
 * AIMarketSummarySkeleton's shimmer building blocks (status cards + list lines) rather than
 * inventing a new loading treatment. */
export function AICoinAnalysisSkeleton() {
  const { t } = useTranslation();
  return (
    <div className="ai-skeleton" role="status" aria-label={t("ai.coinAnalysis.skeletonLabel")}>
