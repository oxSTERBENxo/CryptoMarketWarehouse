...
from integrations.coingecko import CoinMarketData

INSERT_SQL = """
    INSERT INTO staging.coingecko_market_snapshot
        (run_id, coin_id, symbol, name, current_price, market_cap, market_cap_rank, total_volume,
         circulating_supply, image_url, price_change_percentage_24h)
